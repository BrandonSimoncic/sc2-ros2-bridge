...
bool sc2_bridge_interfaces__msg__contact_mark__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sc2_bridge_interfaces.msg._contact_mark.ContactMark", full_classname_dest, 51) == 0);
  }
  sc2_bridge_interfaces__msg__ContactMark * ros_message = _ros_message;
  {  // mark_id
    ...
    ros_message->mark_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // tag
...
{
  /* NOTE(esteve): Call constructor of ContactMark */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sc2_bridge_interfaces.msg._contact_mark");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ContactMark");
  ...
  {  // mark_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->mark_id);
    {
