...
static const _UnitStateArray_type_support_symbol_names_t _UnitStateArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sc2_bridge_interfaces, msg, UnitStateArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sc2_bridge_interfaces, msg, UnitStateArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sc2_bridge_interfaces, msg, UnitStateArray)() {
  return &::sc2_bridge_interfaces::msg::rosidl_typesupport_c::UnitStateArray_message_type_support_handle;
}
