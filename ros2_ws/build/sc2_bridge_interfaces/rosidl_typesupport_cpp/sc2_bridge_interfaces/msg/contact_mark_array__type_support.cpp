...
static const _ContactMarkArray_type_support_symbol_names_t _ContactMarkArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sc2_bridge_interfaces, msg, ContactMarkArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sc2_bridge_interfaces, msg, ContactMarkArray)),
  }
};
...
{
  return &::sc2_bridge_interfaces::msg::rosidl_typesupport_cpp::ContactMarkArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sc2_bridge_interfaces, msg, ContactMarkArray)() {
  return get_message_type_support_handle<sc2_bridge_interfaces::msg::ContactMarkArray>();
}
