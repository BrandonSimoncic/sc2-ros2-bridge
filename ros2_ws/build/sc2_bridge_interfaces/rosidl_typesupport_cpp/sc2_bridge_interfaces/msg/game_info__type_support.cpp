...
static const _GameInfo_type_support_symbol_names_t _GameInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sc2_bridge_interfaces, msg, GameInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sc2_bridge_interfaces, msg, GameInfo)),
  }
};
...
{
  return &::sc2_bridge_interfaces::msg::rosidl_typesupport_cpp::GameInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sc2_bridge_interfaces, msg, GameInfo)() {
  return get_message_type_support_handle<sc2_bridge_interfaces::msg::GameInfo>();
}
